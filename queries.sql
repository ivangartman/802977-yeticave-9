...
VALUES ('1', '1', '2014 Rossignol District Snowboard', 'Описание лота', 'img/lot-1.jpg', '10999', '2019-04-25 00:00:00', '1'),
       ('1', '1', 'DC Ply Mens 2016/2017 Snowboard', 'Описание лота', 'img/lot-2.jpg', '159999', '2019-04-26 00:00:00', '1'),
       ('2', '2', 'Крепления Union Contact Pro 2015 года размер L/X', 'Описание лота', 'img/lot-3.jpg', '8000', '2019-04-24 00:00:00', '1'),
       ('1', '3', 'Ботинки для сноуборда DC Mutiny Charocal', 'Описание лота', 'img/lot-4.jpg', '10999', '2019-04-28 00:00:00', '1'),
       ('2', '4', 'Куртка для сноуборда DC Mutiny Charocal', 'Описание лота', 'img/lot-5.jpg', '7500', '2019-04-23 00:00:00', '1'),
       ('2', '6', 'Маска Oakley Canopy', 'Описание лота', 'img/lot-6.jpg', '5400', '2019-04-29 00:00:00', '1');

-- Заполнение таблицы ставки 'rate'
INSERT INTO rates (user_id, lot_id, price)
VALUES ('2', '1', '11000'),
       ('2', '2', '16000'),
       ('1', '3', '8100'),
       ('2', '4', '11500'),
